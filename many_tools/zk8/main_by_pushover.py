...
WAIT_HOT_COUNT = 3
MANY_HOT_TO_SEND_WITH_EMAIL_COUNT = 20
        ...
        for index, hour_hots in enumerate(soup_find):
            ...
            for hour_hot in all_hour_hots:
                ...
                if text:
                    ...
                    if uri not in exist_titles_set:
                        result[name] = uri
                        is_get_new = True
...
if __name__ == '__main__':
    ...
    important_key_messages = {u"有水", u"水了", u'高返', u'高反', u'高佣',
                              ...
                              u'好用', u'中了', u'转赠', u'货号', u'来不及', u'又有',
                              u'叠加', u'双重', u'出了', u'白条', u'还款', u'出征', 'bug',
                              u'快快', u'好去处', u'警告'}
    key_messages = {u'神', u'券', u'卷', u'抢', u'立减', u'快', u'速',
                    u'防身', u'性价比', u'便宜', u'秒杀',
                    u'秒到', u'可以了', u'有货', u'防身',
                    u'利器', u'来了', u'又1', u'免费', u'0元', u'震惊',
