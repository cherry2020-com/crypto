...
# CORP_API_TYPE = {
#     # 获取token
#     'GET_ACCESS_TOKEN': ['/UserInterface.aspx', 'GET'],
#     'USER_INFO' 	: ['UserInterface.aspx?action=getaccountinfo', 'GET'],
#     'SEARCH_PROJ' :['/appapi.aspx','GET'],
#     'GET_PHONE' : ['/UserInterface.aspx','GET'],
#     'GET_MSG':['UserInterface.aspx?','GET'], # 获取短信接口
#     'SEND_MSG': ['UserInterface.aspx','GET'],
...
class CorpApi(object) :
    ...
    def get_phone(self,pid,excludeno=''):
        '''
            获取手机号 20941
        '''
        ...
        response = self.httpCall(
            CORP_API_TYPE['GET_PHONE'],params).text
    ...
    def get_msg(self,pid,phone):
        ...
        response = self.httpCall(CORP_API_TYPE['GET_MSG'],params).text
        print(response)
...
# print(token)
# CorpApi.get_userinfo()
# CorpApi.search_proj('乐')
# phone = CorpApi.get_phone(20941)
# print(phone)

while 1:
    msg = CorpApi.get_msg(20941, 17029867178)
    print(msg)
    time.sleep(2)
